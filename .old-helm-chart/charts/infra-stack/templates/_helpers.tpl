...
{{ include "infra-stack.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "infra-stack.selectorLabels" -}}
...
*/}}
{{- define "infra-stack.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "infra-stack.fullname" .) .Values.serviceAccount.name }}
{{- else }}
